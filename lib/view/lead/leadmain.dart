...
class _LeadmainState extends State<Leadmain> {
  ...
  Widget build(BuildContext context) {
    return Container(color: const Color(0xFFF0F6F4),child: const Column(
      children:<Widget> [
        Contactdetails(name: 'Athish', date: '15/01/24', email: 'demo@gmail.com', landphone: '0487 2551998', condition:  Contactconditions.newcontact),
      ],
    ));
  }
}