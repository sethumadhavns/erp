            ...
            children: <Widget>[
                    ...
                    children: <Widget>[
                      ...
                      Column(
                        ...
                        children: <Widget>[
                          ...
                          Gap(5.h),
                          medium.reg14(
                              text: widget.date!, color: Color(0xFF5D5D5D))
                        ],
                      ),
                    ],
                  ),
              ...
              if (widget.whatsapp!=null)
                      ...
                      children: <Widget>[
                        GestureDetector(
                          onTap: () {
                            setState(() {
                              if (selectedbutton == 1) {
                                selectedbutton = null; // Reset to original state
                              } else {
                                selectedbutton = 1;
                              }
                            });
                ...
                GestureDetector(
                  ...
                  child: Chip(
                      backgroundColor:
                          selectedbutton == 3 ? Color(0xFF367B86) : Colors.white,
